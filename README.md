...
| Random Forest | Achieved the best overall performance with perfect precision (1.0), highest AUC (1.0), and high MCC. Ensemble learning reduces overfitting and improves prediction stability. |
| XGBoost | Performed similar to Random Forest with very high accuracy (98.5%) and strong MCC. Boosting technique improves prediction performance and handles complex patterns effectively. |
